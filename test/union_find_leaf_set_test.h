...
TEST(get_nth_partition_tuple, no_constraints) {
    UnionFind union_find(10);
    UnionFindLeafSet leafset(union_find);
...
TEST(get_nth_partition_tuple, only_one_set) {
    UnionFind union_find(10);
    UnionFindLeafSet leafset(union_find);
    std::vector<constraint> constraints;
...
TEST(get_nth_partition_tuple, only_one_leaf) {
