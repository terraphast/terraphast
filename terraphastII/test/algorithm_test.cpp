...
static void test_rooted_trees(const char *newick_file, const char *data_file, long trees_on_terrace) {
    ...
    for(auto &root_species_name : get_root_species(m)) {
        ...
        for (size_t k = 0; k < m->numberOfSpecies; k++) {
            ...
            if (noData) {
                dout("Species with no data in any split: " << m->speciesNames[k] << "\n");
                assert(0);
            }
...
TEST(ApplyConstraintsTest, example_from_slides) {
    ...
    auto result = leaves.get_list_of_splits();
...
TEST(GetNthsplitTuple, example_with_two_parts) {
...
TEST(GetNthsplitTuple, example_from_slides) {
    ...
    ASSERT_EQ(leaves.number_split_tuples(), 3);
...
TEST(GetNthsplitTuple, with_four_splits) {
    ...
    ASSERT_EQ(leaves.number_split_tuples(), 7);
...
INSTANTIATE_TEST_CASE_P(ModifiedDataInstance, RootedTreesAnalysis, ::testing::Values(
        RootedTreesCountParameter("../../data/subsets/Allium.nwk",
                                  "../../data/subsets/Allium.data",
                                  8038035),
        RootedTreesCountParameter("../../data/subsets/Allium_Reduced.nwk",
                                  "../../data/subsets/Allium_Reduced.data",
                                  730680125),
        RootedTreesCountParameter("../../data/subsets/Allium_Tiny.nwk",
                                  "../../data/subsets/Allium_Tiny.data",
                                  35),
        RootedTreesCountParameter("../../data/subsets/Asplenium.nwk.1",
                                  "../../data/subsets/Asplenium.data.1",
                                  1),
        RootedTreesCountParameter("../../data/subsets/Asplenium.nwk.2",
                                  "../../data/subsets/Asplenium.data.2",
                                  95),
        RootedTreesCountParameter("../../data/subsets/Bouchenak.nwk",
                                  "../../data/subsets/Bouchenak.data",
                                  61261515),
        RootedTreesCountParameter("../../data/subsets/Caryophyllaceae.nwk",
                                  "../../data/subsets/Caryophyllaceae.data",
                                  718346120625),
        RootedTreesCountParameter("../../data/subsets/Eucalyptus.nwk.1",
                                  "../../data/subsets/Eucalyptus.data.1",
                                  229),
        RootedTreesCountParameter("../../data/subsets/Eucalyptus.nwk.1",
                                  "../../data/subsets/Eucalyptus.data.2",
                                  267),
        RootedTreesCountParameter("../../data/synthetic/Synthetic_7t_4p.nwk",
                                  "../../data/synthetic/Synthetic_7t_4p.data",
                                  9),
        RootedTreesCountParameter("../../data/subsets/Euphorbia.nwk.1",
                                  "../../data/subsets/Euphorbia.data.1",
                                  759),
        RootedTreesCountParameter("../../data/subsets/Euphorbia.nwk.2",
                                  "../../data/subsets/Euphorbia.data.2",
                                  759),
        RootedTreesCountParameter("../../data/subsets/Ficus.nwk.1",
                                  "../../data/subsets/Ficus.data.1",
                                  283815),
        RootedTreesCountParameter("../../data/subsets/Ficus.nwk.2",
                                  "../../data/subsets/Ficus.data.2",
                                  851445),
        RootedTreesCountParameter("../../data/subsets/Ficus.nwk.3",
                                  "../../data/subsets/Ficus.data.3",
                                  851445),
        RootedTreesCountParameter("../../data/subsets/Iris.nwk",
                                  "../../data/subsets/Iris.data",
                                  1),
        RootedTreesCountParameter("../../data/subsets/Meusemann.nwk",
                                  "../../data/subsets/Meusemann.data",
                                  1),
        RootedTreesCountParameter("../../data/subsets/Pyron.nwk",
                                  "../../data/subsets/Pyron.data",
                                  2205)
));
